#ifndef __FROG__DUCK__PARTICLEEMITTER3D_H__
#define __FROG__DUCK__PARTICLEEMITTER3D_H__
...
/// SceneNodeParticleEffect.  When an emitter is deleted, it deletes all the particles
...
/// emitter.
class SceneNodeParticleEmitter : public SceneNode
{
public:
   enum 
   {
   ...
   /// Called by the SceneNodeParticleEffect on every frame.
   ...
   virtual Particle3D* Emit() = 0;

   /// Set a pointer to the SceneNodeParticleEffect that updates this emitter.
   /// This should only be called by the effect in question.
   void EffectSet(SceneNodeParticleEffect* _effect) { effect = _effect; }
   ...
   /// Note that the base SceneNodeParticleEmitter does not call EmissionActiveBegin()
...
class ParticleEmitterPointSceneNode : public SceneNodeParticleEmitter
{
public:
...
/// the emitter.
class ParticleEmitterLineSceneNode : public SceneNodeParticleEmitter
{
public:
...
/// emitter.
class ParticleEmitterBoxSceneNode : public SceneNodeParticleEmitter
{
public:
...
#endif //#ifndef __FROG__DUCK__PARTICLEEMITTER3D_H__

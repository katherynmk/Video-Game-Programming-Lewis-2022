#ifndef __FROG__DUCK__PARTICLEMANAGER3D_H__
#define __FROG__DUCK__PARTICLEMANAGER3D_H__
...
public:
   ...
   typedef void (*ModifierInitializer)(const char* modifierType,
      SceneNodeParticleEffectEmitter* emitter,
      JSONValue* specifications, const char* filename);
...
#endif //#ifndef __FROG__DUCK__PARTICLEMANAGER3D_H__

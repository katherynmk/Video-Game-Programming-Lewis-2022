#ifndef __FROG__FROG3D__PARTICLE3D_H__
#define __FROG__FROG3D__PARTICLE3D_H__
...
struct RenderData;
class ParticleEmitterSceneNode;
...
public:
   ...
   void ParticleSceneNodeSet(RenderSceneNode* _particleSceneNode);
   ...
   /// Set a pointer to the ParticleEmitterSceneNode that owns this particle.
   /// This should only be called by the emitter in question.
   void EmitterSet(ParticleEmitterSceneNode* _emitter) { emitter = _emitter; }
   /// Return the ParticleEmitterSceneNode that owns this particle.
   ParticleEmitterSceneNode* EmitterGet() { return emitter; }
...
protected:
   ...
   /// The ParticleEmitterSceneNode that owns this particle.
   ParticleEmitterSceneNode* emitter;
   
   /// Scene node for the particle.
   RenderSceneNode* particleSceneNode;
   /// Scene node for the sprite to be drawn for the particle.
   SpriteShapeSceneNode* spriteShapeSceneNode;
   /// Scene node for controlling the position and orientation of the particle.
   BillboardTransformControllerSceneNode* billboardTransformControllerSceneNode;
};
...
#endif //#ifndef __FROG__FROG3D__PARTICLE3D_H__
